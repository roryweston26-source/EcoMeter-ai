...
**Open, and deliberately not done:** no `hosted` block for DeepSeek or Mistral Small (badged but unmeasured); **Kimi is the weakest of the three picks on evidence** — it appears in no OpenRouter top-10 while Xiaomi's MiMo and Tencent's Hunyuan both move more tokens (A10).
