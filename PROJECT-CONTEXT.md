...
- **The "recalibrated 2026, MAE 32%→8%" claim** in the tokenizer comments has **no reproducible artefact in the repo** — no calibration script, corpus, or fixture. The number may well be right, but nothing here can confirm it, and it is quoted in the UI as an accuracy band.
